...
> voci P0/P1 nella task list di sessione (effimera). Aggiornato 2026-09-09.

**P1 — prossimo**
- **[P1] Isybank — incontro Valitutti (10 set 2026)** — area: `apps/isybank-momento` + `docs/Intesa Sanpaolo/` · QC tecnico FATTO 9 set (build, 0 HARD, screenshot letti). **Azioni umane**: run-through deck+dossier; confermare a voce lo stack CRM/comunicazioni in app di Isybank e l'uso di Adobe Analytics (fonte interna); chiedere intro a Claudia Vassena; **NON parlare del rinnovo Analytics ISP (30/09)** con lui → account team ISP. Console + dossier gated già seedati (`0012`) (agg. 2026-09-09).
