...
| **«Il momento giusto» (Isybank)** | **Nuova 9 set** (§31): deck IT 3 capitoli + 6 idee gated + `/dossier/` noindex; `.im-*` blu/menta/arancio; `audit:deck` 0 HARD (16 soft accettate); screenshot letti 1920/1280. | Base `/isybank-momento/`. **Non seedata in console** (P2). Brief riservato git-ignored. |
