...
- **Template slide-momento** (`align="split"`, bg inverse): backdrop **Firefly** full-bleed sotto scrim gradiente `:global(.uc-story-scrim)`; sinistra kicker «Momento 0n di 05 · capitolo» + titolo display + narrativa 4–5 righe + link «↳ Tra poco dal vivo, capitolo 0n»; destra **mock UI** del touchpoint (`.uc-mock*`). Dati in `marcoMoments[]`.
...
- `slide-engine-map`: ogni card ha «Per Marco»; 05/06 anche «Dentro UniCredit». Lead: «I cinque momenti di Marco girano su sei motori…».
