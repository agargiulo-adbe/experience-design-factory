...
1. **`docs/HANDOVER.md`** — **read this first.** Dated current state (2026-09-02). **Splittato per dimensione** (contratto ≤48KB/≤1500 righe per file, via il comando `/handover`): `HANDOVER.md` è un **manifest** che instrada a **`docs/HANDOVER-01.md`** (§1–11: stato generale — ora **7 esperienze** incl. **Eni Orbita** e **Alfabeti MIM** —, architettura, comandi, stato per esperienza, UniCredit content model §5, feature runtime deck §6, Admin §7, **audit-vs-legibility §8**, deploy §9, **backlog prioritario §10** (P1 dossier UniCredit QC live / Eni pre-meeting Chessa 10 set / VPN; poi P2), **change log datato §11** — in cima il 2 set: UniCredit attribution + dossier, Alfabeti MIM), **`docs/HANDOVER-02.md`** (§12–17: puntatori §12, **Factory Showcase §13**, **Ferrari /scoping §14**, **Hub/parity/Connessioni-Trenitalia §15** — §15.3–15.4 struttura superata dalla biforcazione §26 ma **vincoli LOCKED sempre validi** —, **Agos §16**, **Brand Visibility + de-AI + /handover §17**) e **`docs/HANDOVER-03.md`** (§18–28: Ferrari scoping §18–19 + **v3 in produzione §20**, **Experience Atelier §21** + core trasversali §22, **redesign E2E 6 deck §23**, **Eni Orbita §24**, **responsive envelope + nav single-line + sweep §25**, **biforcazione Connessioni Intelligenti FS Park × Trenitalia §26** + **revisioni 1 set §26.7**, **UniCredit attribution «Analizza» + Dossier login-gated §27**, **Alfabeti MIM §28**). Leggi tutte e tre le parti (≈21k tok totali); ognuna sta in una singola `Read`.
