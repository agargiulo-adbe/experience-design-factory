...
1. **`docs/HANDOVER.md`** — **read this first.** Dated current state (2026-09-01). **Splittato per dimensione** (contratto ≤48KB/≤1500 righe per file, via il comando `/handover`): `HANDOVER.md` è un **manifest** che instrada a **`docs/HANDOVER-01.md`** (§1–11: stato generale — ora **6 esperienze** incl. **Eni Orbita**, ⚠️ CI rossa su lint tooling —, architettura, comandi, stato per esperienza, UniCredit content model §5, feature runtime deck §6, Admin §7, **audit-vs-legibility §8**, deploy §9, **backlog prioritario §10** (P0 lint CI · P1 Eni pre-meeting Chessa 10 set / VPN / showcase a11y), **change log datato §11**), **`docs/HANDOVER-02.md`** (§12–17: puntatori §12, **Factory Showcase §13**, **Ferrari /scoping §14**, **Hub/parity/Connessioni-Trenitalia §15** — §15.3–15.4 struttura superata dalla biforcazione §26 ma **vincoli LOCKED sempre validi** —, **Agos §16**, **Brand Visibility + de-AI + /handover §17**) e **`docs/HANDOVER-03.md`** (§18–26: Ferrari scoping §18–19 + **v3 in produzione §20**, **Experience Atelier §21** + core trasversali §22, **redesign E2E 6 deck §23**, **Eni Orbita §24** (deck EN/IT + dossier war-room, meeting CIO Chessa 10 set 2026), **responsive envelope + nav single-line + sweep §25**, **biforcazione Connessioni Intelligenti FS Park × Trenitalia §26** + **revisioni 1 set §26.7**: copy/obiezione CDP/connettori verificati/2 closer, Elena rimossa). Leggi tutte e tre le parti (≈20k tok totali); ognuna sta in una singola `Read`.
