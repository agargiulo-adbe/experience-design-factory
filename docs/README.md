...
1. **`docs/HANDOVER.md`** — **read this first.** Dated current state (2026-09-07). **Splittato per dimensione** (contratto ≤48KB/≤1500 righe per file, via il comando `/handover`): `HANDOVER.md` è un **manifest** che instrada a **4 parti**: **`docs/HANDOVER-01.md`** (§1–10: stato generale — ora **7 esperienze** incl. **Eni Orbita** e **Alfabeti MIM** —, architettura, comandi, stato per esperienza, **UniCredit content model §5** — deck ora **bilingue IT/EN** —, feature runtime deck §6, Admin §7, **audit-vs-legibility §8**, deploy §9, **backlog prioritario §10** — P1 Eni pre-meeting Chessa 10 set / VPN; poi P2), **`docs/HANDOVER-02.md`** (§11–14: **change log datato §11** — in cima il 2 set: **UniCredit bilingue IT/EN + Dossier shareable-link**, poi attribution+dossier, Alfabeti MIM —, puntatori §12, **Factory Showcase §13**, **Ferrari /scoping §14**), **`docs/HANDOVER-03.md`** (§15–22: **Hub/parity/Connessioni-Trenitalia §15** — §15.3–15.4 struttura superata dalla biforcazione §26 ma **vincoli LOCKED sempre validi** —, **Agos §16**, **Brand Visibility + de-AI + /handover §17**, Ferrari scoping §18–19 + **v3 in produzione §20**, **Experience Atelier §21** + core trasversali §22).
   **`docs/HANDOVER-04.md`** (§23–29: **redesign E2E 6 deck §23**, **Eni Orbita §24**, **responsive envelope + nav single-line + sweep §25**, **biforcazione Connessioni Intelligenti FS Park × Trenitalia §26** + **revisioni 1 set §26.7**, **UniCredit attribution «Analizza» + Dossier login-gated + unlisted secret-link + deck bilingue §27**, **MIM «La voce del Ministero» §28** — customer re-arch §28.1–3 + redesign 100% B1 §28.4 + imagery Firefly §28.5 + **§28.6 STATO ATTUALE (7 set): arricchimento + persona Giulia + imagery non-letterform/23 backdrop per-slide + `/trasformazione` rimossa** — e **Firefly asset+video pipeline §29**). Leggi tutte e quattro le parti (≈21k tok totali); ognuna sta in una singola `Read`.
