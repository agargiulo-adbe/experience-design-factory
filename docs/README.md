...
1. **`docs/HANDOVER.md`** — **read this first.** Dated current state (2026-09-09). **Splittato per dimensione** (contratto ≤48KB/≤1500 righe per file, via il comando `/handover`): `HANDOVER.md` è un **manifest** che instrada a **5 parti**: **`docs/HANDOVER-01.md`** (§1–10: stato generale — **7 esperienze cliente** incl. **Eni Orbita** e **Alfabeti MIM**, più **Aperture** (deck di ricerca, 8 set) —, architettura, comandi, stato per esperienza, **UniCredit content model §5** — deck **bilingue IT/EN** + **§5.6 «workshop cut» 7 set: 6 capitoli, single-persona Marco, backdrop Firefly** —, feature runtime deck §6, Admin §7, **audit-vs-legibility §8**, deploy §9, **backlog prioritario §10** — P1 **FSTechnology Adobe Day (fine set)** / Eni pre-meeting Chessa 10 set / VPN / **Atelier: confermare date e decisione del pass 8 set** / dossier UniCredit; poi P2), **`docs/HANDOVER-02.md`** (§11–13: **change log datato §11** — in cima il **9 set: MIM evoluzione UI/UX + Firefly Video sbloccato; 8 set: Aperture + pass critique Atelier + dossier FSTechnology Adobe Day + skill «dossier=pagina web interna»**, poi il **7 set: UniCredit workshop cut + fix deck trasversali** —, puntatori §12, **Factory Showcase §13**),
