...
- [Parte 2 di 5](./HANDOVER-02.md) — §11. **Change log datato** (in cima **9 set pom.: Isybank fonti/copy/Firefly + fix poster Isybank/MIM; 9 set: Isybank nuova experience, MIM evoluzione UI/UX + Firefly Video; 8 set: Aperture, pass critique Atelier, dossier FSTechnology Adobe Day + skill «dossier=pagina web interna»**; poi 7 set UniCredit workshop cut + fix deck trasversali; MIM 7/4 set, Agos, bilingue UniCredit, ecc.); 12. Puntatori; 13. **Factory Showcase (iperdettaglio)** (§13.4 skill + output dossier)
