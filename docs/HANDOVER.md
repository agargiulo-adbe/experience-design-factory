...
- [Parte 1 di 3](./HANDOVER-01.md) — §1. Cos'è e stato generale (ora **6 esperienze** incl. **Eni Orbita**; ⚠️ CI rossa su lint tooling); 2. Architettura; 3. Comandi; 4. Stato per esperienza; 5. UniCredit content model; 6. Feature runtime deck; 7. Admin Console; 8. **Audit-vs-legibility**; 9. Deploy & segreti; 10. **Pending/backlog prioritario (P0 lint CI · P1 Eni pre-meeting/VPN/showcase-a11y)**; 11. Change log datato (biforcazione Trenitalia 31 ago · Eni 28 ago · redesign 21 lug · UniCredit · Hub · Showcase)
