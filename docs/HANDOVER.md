...
> Documento di passaggio di consegne. Stato al **2026-09-01**.
...
- [Parte 1 di 3](./HANDOVER-01.md) — §1. Cos'è e stato generale (ora **6 esperienze** incl. **Eni Orbita**; CI lint di nuovo verde dal 1 set); 2. Architettura; 3. Comandi; 4. Stato per esperienza; 5. UniCredit content model; 6. Feature runtime deck; 7. Admin Console; 8. **Audit-vs-legibility**; 9. Deploy & segreti; 10. **Pending/backlog prioritario (P1 Eni pre-meeting/VPN — azioni umane)**; 11. Change log datato (CI lint + Selling-to-Executives + a11y 1 set · Atelier depubblicata 1 set · biforcazione Trenitalia 31 ago · Eni 28 ago · redesign 21 lug)
